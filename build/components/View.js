...
/**
     ...
     * @platform android
     */
accessibilityComponentType:_propTypes2['default'].oneOf(AccessibilityComponentType),
...
_propTypes2['default'].oneOf(AccessibilityTraits),
_propTypes2['default'].arrayOf(_propTypes2['default'].oneOf(AccessibilityTraits))]),
